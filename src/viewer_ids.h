...
enum {
    ...
    V_FONT, V_LZ, V_PS, V_PURPLE, V_ARL, V_MAC, V_HEX, V_RAW, V_TEXT, V_AWP, V_AWD, V_UNWRAP, V_SCII, V_SHAPES, V_RUN
};
...
static const char* const media_names[] = {
    ...
    "FONTVIEW","LZ4FH","PRINTSHOP","PURPLE","ARLEQUIN","MACPAINT","HEX","IMAGE","TEXT","AWP","AWDATA","UNWRAP","SCIIBIN","SHAPES","RUN"
};
