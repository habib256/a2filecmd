/* Reflected CRC-32 table: a byte at a time avoids eight expensive
 * 32-bit C shifts per input byte on a 6502. No AUX memory. */
static const unsigned long image_crc_table[256]={
