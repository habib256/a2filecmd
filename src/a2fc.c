...
static const char mn_group3[] = "|FORMAT|DISKIMG|IMGFS|DOSGET|DOSWRITE|BOOTBLK|BLKVIEW|BLKEDIT|DISKCMP|NIBCOPY|IMGCONV|MKIMAGE|RESCUE|UNDELETE|VOLNAME|VOLINFO|WIPE|VERIFY|";
