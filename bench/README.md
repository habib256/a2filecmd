...
Ils partent tous de **`dist/A2FILECMD-6502-BOOT.po` tel qu'il sera telecharge** : ce
...
`dist/A2FILECMD-6502-BOOT.po` est l'**edition disquette**, construite en 6502
...
`hd.py` amorce `dist/A2FILECMD-65C02-XL.2mg` ;
...
`dist/A2FILECMD-6502-BOOT.po` jusqu'aux panneaux. `Pom2(..., floppy2=...)` met une
