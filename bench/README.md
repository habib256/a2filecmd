...
Ils partent tous de **`dist/A2FILECMD-6502.po` tel qu'il sera telecharge** : ce
...
`dist/A2FILECMD-6502.po` est l'**edition disquette**, construite en 6502
...
`hd.py` amorce `dist/A2FILECMDXL-65C02.2mg`, l'**edition complete** publiee.
...
`dist/A2FILECMD-6502.po` jusqu'aux panneaux. `Pom2(..., floppy2=...)` met une
