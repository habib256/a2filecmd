...
| `capture_panels.py` | pas un banc : reprend la capture 80 colonnes du README et du manuel depuis le `.2mg` enhanced publié, lignes doublées en 560 × 384, image source vérifiée inchangée ; écrit `docs/screenshots/prodos-panels-<version>.{png,txt,json}` |
