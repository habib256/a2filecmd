...
The table describes the current 0.8.7 source build. The latest published release
is 0.8.6; its downloads retain their own version numbers.

| Image (0.8.7) | Contents |
|---|---|
| `A2FILECMD-6502-BOOT-0.8.7.dsk` | Bootable 140 KB floppy: file manager, essential disk tools and formatter |
| `A2FILECMD-6502-FILES-0.8.7.dsk` | Edit and read documents, find, rename, copy, synchronize and unpack files |
| `A2FILECMD-6502-MEDIA-0.8.7.dsk` | Pictures, Mockingboard and Electric Duet music |
| `A2FILECMD-6502-DISKTOOLS-0.8.7.dsk` | Disk images, block tools, boot repair and recovery |
| `A2FILECMD-6502-DEVTOOLS-0.8.7.dsk` | BASIC listings, disassembly, BASIC.SYSTEM and INTBASIC.SYSTEM |
| `A2FILECMD-6502-XL-0.8.7.2mg` | Complete bootable 32 MB image for 6502 |
| `A2FILECMD-65C02-XL-0.8.7.2mg` | Complete bootable 32 MB image for 65C02, with optional mouse support |
| `A2FC-MINI-DOS33-0.8.7.dsk` | A2FileCmd Mini DOS3.3: the standalone edition for a 48 KB Apple II+ |
